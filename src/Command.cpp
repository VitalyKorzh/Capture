...
void help() 
{
    ...
    << "\t[count-center] - если флаг установлен дополнительно считается распределение ларморовских центров, по умолчанию убран\n"
    ...
    << "\t\tlines=[=1 >0] - число линий инжекции, используется если у пучка есть ширина или разброс по углу\n"
