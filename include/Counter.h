...
private:
    ...
    void countIonN(const uiarray &array, darray &result);
...
public:
    ...
    double getnCap(uint index, const uiarray &array) const { return ((double) array[index]) / (nParticles-nFlyby); }
